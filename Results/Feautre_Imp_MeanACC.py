...
data = pd.read_csv("All_Best_GPSCHYPE_MeanACC.csv")
print(data)
y = data.pop(' MeanACC')
...
plt.title("Feature Importance Analysis on Mean ACC")
...
df_test.to_csv("MeanACC_Feature importance.csv", index = False)
print(df_test)