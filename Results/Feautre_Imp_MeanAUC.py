...
data = pd.read_csv("All_Best_GPSCHYPE_MeanAUC.csv")
print(data)
y = data.pop('MeanAUC')
...
plt.title("Feature Importance Analysis on Mean AUC")
...
df_test.to_csv("MeanAUC_Feature importance.csv", index = False)
print(df_test)