...
data = pd.read_csv("All_Best_GPSCHYPE_MeanF1Score.csv")
print(data)
y = data.pop('MeanF1Score')
...
plt.title("Feature Importance Analysis on Mean F1 Score")
...
# plt.show()
plt.savefig("FI_Mean_F1_Score.png",
            dpi = 300,
            bbox_inches = "tight")