...
data = pd.read_csv("All_Best_GPSCHYPE_AverageDepth.csv")
print(data)
y = data.pop('Average depth')
...
plt.bar(x-0.75, FI_DF_1['importance'], width=0.5,zorder=3, label="DecisionTree\nRegressor")
plt.bar(x-0.25, feature_importance_df['importance'],width=0.5,zorder=3, label="RandomForest\nRegressor")
plt.bar(x+0.25, FI_DF_3['importance'], width=0.5,zorder=3, label="ExtraTrees\nRegressor")
plt.bar(x+0.75, FI_DF_4['importance'], width=0.5,zorder=3, label="GradientBoosting\nRegressor")
